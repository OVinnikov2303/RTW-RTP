      ...
      <section className="py-20">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              RTW-RTP було засновано у 2020 році групою ентузіастів, яким набридло орієнтуватися в переповнених каталогах товарів із нестабільною якістю. Ми поставили за мету створити кураторський маркетплейс, де кожен товар заслуговує на своє місце.
            </p>
            <p>
